...
<title>Project Worlds || ONLINE TEST </title>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<!-- <div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">JAMSITH ASSLAM</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9876543210</h4>
		<h4 style="font-family:'typo' ">jamzzith@gmail.com</h4>
		<h4 style="font-family:'typo' ">Rajalakshmi Engineering College</h4></div></div>
		</p>
      </div>
